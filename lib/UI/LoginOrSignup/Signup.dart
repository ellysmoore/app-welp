                            ...
                            Container(
                              ...
                              child: Column(
                                children: <Widget>[
                                  ...
                                  Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Hero(
                                        tag: "Welp Services",
                                        child: Text(
                                          AppLocalizations.of(context).tr('Welp Services'),
                                          style: TextStyle(
                                  ...
                                  /// TextFromField Number
                                  textFromField(
                                    icon: Icons.phone,
                                    password: false,
                                    email: AppLocalizations.of(context).tr('Phone Number'),
                                   ...
                                   Padding(
                                      padding:
                                          EdgeInsets.symmetric(vertical: 5.0)),
                                  /// TextFromField account type
                                  textFromField(
                                    icon: Icons.phone,
                                    password: false,
                                    email: AppLocalizations.of(context).tr('User/service provider'),
