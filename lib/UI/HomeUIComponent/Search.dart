...
class _searchAppbarState extends State<searchAppbar> {
  ...
  var _textHello = Padding(
    ...
    child: Text(
      AppLocalizations.of(context).tr('Hi, what would you like to search for?'),
      style: TextStyle(
          letterSpacing: 0.1,
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                FavoriteItem(
                  ...
                  title: AppLocalizations.of(context).tr('Autograph Salon'),
                  Salary: "\$ 40",
                  Rating: "4.8",
                ...
                FavoriteItem(
                  ...
                  title: AppLocalizations.of(context).tr('Autoshop'),
                  Salary: "\$ 200",
                  Rating: "4.2",
                ...
                FavoriteItem(
                  ...
                  title: AppLocalizations.of(context).tr('James Mechanics'),
                  Salary: "\$ 3",
                  Rating: "4.8",
  ...
  var _sugestedText = Container(
      ...
      children: <Widget>[
        ...
        Expanded(
          ...
          children: <Widget>[
            Padding(padding: EdgeInsets.only(left: 20.0)),
            KeywordItem(
              title: AppLocalizations.of(context).tr('Beauty/Fashion'),
              title2: AppLocalizations.of(context).tr('Technicial'),
            ),
            KeywordItem(
           title: AppLocalizations.of(context).tr('Home'),
              title2: AppLocalizations.of(context).tr('Office'),
            ),
            KeywordItem(
              title: AppLocalizations.of(context).tr('Engineer'),
              title2: AppLocalizations.of(context).tr('Errands'),
            ),
            KeywordItem(
             title: AppLocalizations.of(context).tr('Creatives'),
              title2: AppLocalizations.of(context).tr('Health'),
            ),
          ],
        ))
      ],
    ...
    return EasyLocalizationProvider(
        ...
        appBar: AppBar(
          title:  Text(AppLocalizations.of(context).tr('search'),style: TextStyle(fontFamily: "Sans",fontSize: 19.0,fontWeight: FontWeight.w500,color: Colors.black54),),
