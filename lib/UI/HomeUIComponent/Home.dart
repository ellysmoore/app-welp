  ...
  Widget build(BuildContext context) {
    ...
    var imageSlider = Container(
      ...
      child: new Carousel(
        ...
        images: [
          AssetImage("assets/img/back1.jpg"),
          AssetImage("assets/img/back.jpg"),
          AssetImage("assets/img/weld.jpg"),
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        CategoryItemValue(
                          ...
                          title: AppLocalizations.of(context).tr('Home/Office'),
                          tap: onClickCategory,
                        ),
                        Padding(
                          padding: EdgeInsets.only(top: 10.0),
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      CategoryItemValue(
                        ...
                        title: AppLocalizations.of(context).tr('General Errands'),
                        tap: onClickCategory,
                      ),
                      Padding(
                        padding: EdgeInsets.only(top: 10.0),
                      ...
                      CategoryItemValue(
                        ...
                        title: AppLocalizations.of(context).tr('Engineering'),
                        tap: onClickCategory,
                      ),
                    ],
                  ),
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      CategoryItemValue(
                        ...
                        title: AppLocalizations.of(context).tr('Technical'),
                        tap: onClickCategory,
                      ),
                      Padding(
                        padding: EdgeInsets.only(top: 10.0),
